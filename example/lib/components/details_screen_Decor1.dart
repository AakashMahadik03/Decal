import 'package:Decal_AR_App/components/showing/objectshow_Decor1.dart';
import 'package:flutter/material.dart';
import 'package:Decal_AR_App/constants.dart';

class DetailsScreen_Decor1 extends StatelessWidget {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          TitleAndPrice(title: "DECOR", country: "UNIQUE", price: 440),
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Objectshow_Decor1(),
                      ),
                    );
                  },
