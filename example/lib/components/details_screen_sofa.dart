import 'package:Decal_AR_App/components/showing/objectshow_sofa.dart';
import 'package:flutter/material.dart';
import 'package:Decal_AR_App/constants.dart';
import 'package:Decal_AR_App/components/showing/objectshow.dart';

import '../examples/objectgesturesexample.dart';

class DetailsScreen_Sofa extends StatelessWidget {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          TitleAndPrice(title: "SOFA", country: "FABRIC LUXURY", price: 440),
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Objectshow_Sofa(),
                      ),
                    );
                  },
