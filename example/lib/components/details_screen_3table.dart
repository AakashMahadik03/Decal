import 'package:Decal_AR_App/components/showing/objectshow_3table.dart';
import 'package:flutter/material.dart';
import 'package:Decal_AR_App/constants.dart';


class DetailsScreen_3table extends StatelessWidget {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          TitleAndPrice(title: "TABLE", country: "3 STAND", price: 440),
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Objectshow_3table(),
                      ),
                    );
                  },
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  ...
                  fit: BoxFit.fill,
                  image: AssetImage("assets/Images/3table.png"),
                ),
              ),
            ),
          ],
