...
import 'package:Decal_AR_App/components/showing/objectshow_wallart1.dart';

import '../examples/objectgesturesexample.dart';

class DetailsScreen_wallart1 extends StatelessWidget {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          TitleAndPrice(title: "PHOTO", country: "FRAME", price: 440),
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Objectshow_wallart1(),
                      ),
                    );
                  },
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  ...
                  fit: BoxFit.fill,
                  image: AssetImage("assets/Images/WallArt.png"),
                ),
              ),
            ),
          ],
