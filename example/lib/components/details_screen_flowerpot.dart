...
import 'package:ar_flutter_plugin_example/components/showing/objectshow_flowerpot.dart';



class DetailsScreen_flowerpot extends StatelessWidget {
  @override
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Objectshow_flowerpot(),
                      ),
                    );
                  },
