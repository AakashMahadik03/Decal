...
import 'package:Decal_AR_App/components/showing/objectshow_titaniclamp.dart';

import '../examples/objectgesturesexample.dart';

class DetailsScreen_titacniclamp extends StatelessWidget {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          TitleAndPrice(title: "LAMP", country: "TITANIC LAMP", price: 440),
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Objectshow_titaniclamp(),
                      ),
                    );
                  },
